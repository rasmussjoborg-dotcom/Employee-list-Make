import svgPaths from "./svg-yr9h31pvz8";
...
function Labelcontainer3() {
  return (
    <div className="content-stretch flex items-center justify-center px-[6px] relative shrink-0" data-name="Labelcontainer">
      <p className="font-['Inter:semibold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#2d0c69] text-[13px]">Add</p>
    </div>
  );
}
...
function Labelcontainer5() {
  return (
    <div className="content-stretch flex items-center justify-center px-[6px] relative shrink-0" data-name="Labelcontainer">
      <p className="font-['Inter:semibold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#2d0c69] text-[13px]">Send</p>
    </div>
  );
}
...
function Labelcontainer6() {
  return (
    <div className="content-stretch flex items-center justify-center px-[6px] relative shrink-0" data-name="Labelcontainer">
      <p className="font-['Inter:semibold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#2d0c69] text-[13px]">Export</p>
    </div>
  );
}
