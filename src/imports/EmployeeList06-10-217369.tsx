import svgPaths from "./svg-iaqu2z771i";
...
function Labelcontainer5() {
  return (
    <div className="content-stretch flex items-center justify-center px-[6px] relative shrink-0" data-name="Labelcontainer">
      <p className="font-['Inter:semibold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[#2d0c69] text-[13px]">{`Product & Tech`}</p>
    </div>
  );
}
...
function Labelcontainer6() {
  return (
    <div className="content-stretch flex items-center justify-center px-[6px] relative shrink-0" data-name="Labelcontainer">
      <p className="font-['Inter:semibold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[13px] text-white">Apply changes</p>
    </div>
  );
}
...
function ArrowRight1() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="arrow-right">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="arrow-right">
          <path clipRule="evenodd" d={svgPaths.p1b17eec0} fill="var(--fill-0, white)" fillRule="evenodd" id="vector" />
        </g>
      </svg>
    </div>
  );
...
function Button7() {
  return (
    <div className="bg-[#2d0c69] content-stretch flex gap-[4px] items-center justify-center overflow-clip p-[8px] relative rounded-[8px] shrink-0" data-name="Button">
      <Labelcontainer6 />
      <TrailingIcon5 />
...
function Frame5() {
  return (
    <div className="content-stretch flex flex-col h-full items-end justify-center relative shrink-0">
      <Button7 />
    </div>
  );
}
