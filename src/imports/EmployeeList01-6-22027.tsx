import svgPaths from "./svg-92p0w6mpsc";
    ...
    <div className="relative shrink-0 w-full" data-name="Heading">
      ...
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex gap-[8px] items-center p-[16px] relative w-full">
          <p className="flex-[1_0_0] font-['Inter:semibold',sans-serif] leading-[24px] min-h-px min-w-px not-italic overflow-hidden relative text-[#16141e] text-[18px] text-ellipsis whitespace-nowrap">Customize Columns</p>
          <Buttons />
        </div>
      </div>
    </div>
...
function Checkbox() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox1 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">Employee</p>
    </div>
  );
}
...
function Checkbox2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox3 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">Contact</p>
    </div>
  );
}
...
function Checkbox4() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox5 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">Organization</p>
    </div>
  );
}
...
function Checkbox6() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox7 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">{`Role & Position`}</p>
    </div>
  );
}
...
function Checkbox8() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox9 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">Employment</p>
    </div>
  );
}
...
function Checkbox10() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox11 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">Dates</p>
    </div>
  );
}
...
function Checkbox12() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox13 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">{`Access & Permissions`}</p>
    </div>
  );
}
...
function Checkbox14() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox15 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">Location</p>
    </div>
  );
}
...
function Checkbox16() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox17 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">Status</p>
    </div>
  );
}
...
function Checkbox18() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox19 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">{`Cost & Finance`}</p>
    </div>
  );
}
...
function Checkbox20() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox21 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">Custom fields</p>
    </div>
  );
}
...
function Checkbox22() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Checkbox">
      <Checkbox23 />
      <p className="font-['Inter:Semi_Bold',sans-serif] font-semibold leading-[20px] not-italic relative shrink-0 text-[#16141e] text-[13px]">{`System & Audit`}</p>
    </div>
  );
}
...
function Level2SlotRows() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start py-[24px] relative shrink-0 w-full" data-name="Level2SlotRows">
      <Checkbox />
      <Checkbox2 />
      <Checkbox4 />
      <Checkbox6 />
...
function Scrollbar() {
  return <div className="absolute bg-[#16141e] bottom-[86px] opacity-25 right-[6px] rounded-[4px] top-[16px] w-[4px]" data-name="Scrollbar" />;
}
...
function Labelcontainer1() {
  return (
    <div className="content-stretch flex items-center justify-center px-[6px] relative shrink-0" data-name="Labelcontainer">
      <p className="font-['Inter:semibold',sans-serif] leading-[20px] not-italic relative shrink-0 text-[13px] text-white">Apply</p>
    </div>
  );
}
...
function FloatingContent() {
  return (
    <div className="-translate-y-1/2 absolute content-stretch flex flex-col h-[966px] items-start overflow-clip pr-[8px] py-[8px] right-0 top-1/2 w-[344px] z-[5]" data-name="FloatingContent">
      <FloatingContent1 />
    </div>
  );
}
...
function Container() {
  return <div className="absolute bg-[rgba(0,0,0,0.16)] h-[1024px] left-0 top-0 w-[1535px] z-[4]" data-name="Container" />;
}
